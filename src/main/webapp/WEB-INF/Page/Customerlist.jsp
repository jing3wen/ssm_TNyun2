                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${customerlist}" var="cst">
                            <tr class="text-c">
                                ...
                                <td>${cst.email}</td>
                                <td>
                                    <c:if test="${cst.status==1}">可用</c:if>
                                    <c:if test="${cst.status==0}">不可用</c:if>
                                </td>
                                <td>
                                    <button type="button"
                                    ...
                                    <a deleteLink="true" href="/Customerlist/del_customer?id=${cst.id}"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="input-group mb-3 input-group-sm">
                                            ...
                                            <button type="button" class="btn btn-primary" id="update_s_name">修改姓名</button>
                                        </div>
                                        <div class="input-group mb-3 input-group-sm">
