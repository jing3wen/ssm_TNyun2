		...
		<div class="row">
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="Services-box">
					<i><img src="../../../images/service1.png" alt="#" id="open_img_1" onclick="service(0)"/></i>
					<h3 id="subsystem_name0" onclick="service(0)">云超市</h3>
					<p id="subsystem_introduction0" onclick="service(0)" >云超市，是一种社区电子商务的交易形式，即网上预定和下单、线下快速到货的一种超市形式。</p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="Services-box">
					<i><img src="../../../images/service2.png" alt="#" onclick="service(1)"/></i>
					<h3 id="subsystem_name1" onclick="service(1)">云体验销售中心</h3>
					<p id="subsystem_introduction1" onclick="service(1)">销售云解决方案可以为客户提供情境化且个性化的全渠道购物体验。给用户带来真实的体验</p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="Services-box">
					<i><img src="../../../images/service3.png" alt="#" onclick="service(2)"/></i>
					<h3 id="subsystem_name2" onclick="service(2)">企业工作台</h3>
					<p id="subsystem_introduction2" onclick="service(2)">整合即时交易管理，提供品质卓越的云协作体验，成就组织和个人，使协作和管理更高效、更愉悦</p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="Services-box">
					<i><img src="../../../images/service4.png" alt="#" /></i>
					<h3 id="subsystem_name3" onclick="service(3)">开发中</h3>
					<p id="subsystem_introduction3" onclick="service(3)"></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="Services-box">
					<i><img src="../../../images/service5.png" alt="#" /></i>
					<h3 id="subsystem_name4" onclick="service(4)">开发中</h3>
					<p id="subsystem_introduction4" onclick="service(4)"></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
				<div class="Services-box">
					<i><img src="../../../images/service6.png" alt="#" /></i>
					<h3 id="subsystem_name5" onclick="service(5)">开发中</h3>
					<p id="subsystem_introduction5" onclick="service(5)"></p>
				</div>
			</div>
...
<script>
	...
	function service(number){
		...
		if(checklogin()==0){
			...
			//记录点击的子系统
			setCookie("sub_system_number",number);
			setCookie("sub_system_s_id",sub_system[number].s_id);
			setCookie("sub_system_s_name",sub_system[number].s_name);
			setCookie("sub_system_s_introduction",sub_system[number].s_introduction);
			setCookie("sub_system_s_price",sub_system[number].s_price);
			$("#myModal").modal('show');
		}
	...
	function findallServiceOrder() {
		console.log("查询改用户是否购买订单");
		//console.log(getCookie("sub_system_s_id"))
		data={
		...
		$.ajax({
			...
			success: function (result) {
				...
				if(result=="not overdue") {
					//console.log(sub_system[getCookie("sub_system_number")].s_website2);
					url="http://"+sub_system[getCookie("sub_system_number")].s_website2;
					//console.log(url);
		...
		$.ajax({
			...
			success: function (result) {
				...
				for(i=0;i<result.length;i++){
					$("#subsystem_name"+i).html(result[i].s_name);
					$("#subsystem_introduction"+i).html(result[i].s_introduction);
				}
