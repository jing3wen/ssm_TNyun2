...
<head>
    ...
    <link href="css/step-lay/step.css" rel="stylesheet">
</head>
<body>
        ...
        <div class="layui-card" >
            <div class="layui-card-body" style="padding-top: 40px;">
                <div class="layui-carousel" id="stepForm" lay-filter="stepForm" style="margin: 0 auto;">
                    <div carousel-item>
                        <div>
                            <form class="layui-form" style="margin: 0 auto;max-width: 460px;padding-top: 40px; padding-right:5%">
               ...
               x.不得帮助他人违反这些规则。</p>
                        ...
                        <div carousel-item>
                            ...
                            <div >
                               <form class="layui-form" style="margin: 0 auto;max-width: 460px;padding-top: 40px;padding-right:10%">
                        ...
                        <div>
                            ...
                            <div style="text-align: center;margin-top: 50px;">
                                <button class="layui-btn next">回到首页</button>                               
                            </div>
                        </div>
                    </div>
                </div>
