...
!function (t, e) {
    ...
    var l = s, u = {
        ...
        getRgba: h, getHsla: c, getRgb: function (t) {
            var e = h(t);
    ...
    S.easingEffects = D;
    var P = Math.PI, T = P / 180, O = 2 * P, A = P / 2, F = P / 4, I = 2 * P / 3, L = {
        clear: function (t) {
    ...
    var z = {
        toLineHeight: function (t, e) {
            ...
            var e = W.global, n = Y(t.fontSize, e.defaultFontSize), i = {
    ...
    H.extend(nt.prototype, {
        ...
        _resolveDataElementOptions: function (t, e) {
            ...
            var r, o, s, l, u = n.chart, d = n._config, h = u.options.elements[n.dataElementType.prototype._type] || {},
                ...
                g = {chart: u, dataIndex: e, dataset: n.getDataset(), datasetIndex: n.index}, m = {cacheable: !i};
            if (i = i || {}, H.isArray(c)) for (o = 0, s = c.length; o < s; ++o) f[l = c[o]] = Q([i[l], d[l], h[l]], g, e, m); else for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o) f[l = r[o]] = Q([i[l], d[c[l]], d[l], h[l]], g, e, m);
    ...
    }), lt = H.valueOrDefault, ut = W.global.defaultColor;
    W._set("global", {
        elements: {
            line: {
                tension: .4,
    ...
    var dt = $.extend({
        _type: "line", draw: function () {
            var t, e, n, i = this, a = i._view, r = i._chart.ctx, o = a.spanGaps, s = i._children.slice(), l = W.global,
    ...
    }), ht = H.valueOrDefault, ct = W.global.defaultColor;
    ...
    var _t = $.extend({
        _type: "rectangle", draw: function () {
            var t = this._chart.ctx, e = this._view, n = function (t) {
                var e = vt(t), n = e.right - e.left, i = e.bottom - e.top, a = yt(t, n / 2, i / 2);
                return {
    ...
    }), wt = {}, kt = st, Mt = dt, St = gt, Dt = _t;
    wt.Arc = kt, wt.Line = Mt, wt.Point = St, wt.Rectangle = Dt;
    var Ct = H._deprecated, Pt = H.valueOrDefault;
    ...
    }), W._set("global", {datasets: {bar: {categoryPercentage: .8, barPercentage: .9}}});
    var Ot = it.extend({
        ...
        calculateBarValuePixels: function (t, e, n) {
            var i, a, r, o, s, l, u, d = this.chart, h = this._getValueScale(), c = h.isHorizontal(),
                f = d.data.datasets, g = h._getMatchingVisibleMetas(this._type), m = h._parseValue(f[t].data[e]),
                p = n.minBarLength, v = h.options.stacked, b = this.getMeta().stack,
                y = void 0 === m.start ? 0 : m.max >= 0 && m.min >= 0 ? m.min : m.max,
                x = void 0 === m.start ? m.end : m.max >= 0 && m.min >= 0 ? m.max - m.min : m.min - m.max, _ = g.length;
        ...
        calculateBarIndexPixels: function (t, e, n, i) {
            var a = "flex" === i.barThickness ? function (t, e, n) {
                ...
                }(e, n, i) : Tt(e, n, i), r = this.getStackIndex(t, this.getMeta().stack),
    ...
    }), At = H.valueOrDefault, Ft = H.options.resolve;
    W._set("bubble", {
        hover: {mode: "single"},
        scales: {
    ...
    }), Lt = H.valueOrDefault, Rt = Math.PI, Nt = 2 * Rt, Wt = Rt / 2;
    W._set("doughnut", {
        ...
        }, cutoutPercentage: 50, rotation: -Wt, circumference: Nt, tooltips: {
            callbacks: {
                title: function () {
                    return ""
                }, label: function (t, e) {
    ...
    var Yt = it.extend({
        ...
        update: function (t) {
            var e, n, i, a, r = this, o = r.chart, s = o.chartArea, l = o.options, u = 1, d = 1, h = 0, c = 0,
                f = r.getMeta(), g = f.data, m = l.cutoutPercentage / 100 || 0, p = l.circumference,
                v = r._getRingWeight(r.index);
            if (p < Nt) {
                var b = l.rotation % Nt, y = (b += b >= Rt ? -Nt : b < -Rt ? Nt : 0) + p, x = Math.cos(b),
                    _ = Math.sin(b), w = Math.cos(y), k = Math.sin(y), M = b <= 0 && y >= 0 || y >= Nt,
                    S = b <= Wt && y >= Wt || y >= Nt + Wt, D = b <= -Wt && y >= -Wt || y >= Rt + Wt,
                    C = b === -Rt || y >= Rt ? -1 : Math.min(x, x * m, w, w * m),
                    P = D ? -1 : Math.min(_, _ * m, k, k * m), T = M ? 1 : Math.max(x, x * m, w, w * m),
        ...
        updateElement: function (t, e, n) {
            var i = this, a = i.chart, r = a.chartArea, o = a.options, s = o.animation, l = (r.left + r.right) / 2,
                ...
                g = n && s.animateScale ? 0 : i.innerRadius, m = n && s.animateScale ? 0 : i.outerRadius,
                p = t._options || {};
            H.extend(t, {
    ...
    }), W._set("global", {datasets: {horizontalBar: {categoryPercentage: .8, barPercentage: .9}}});
    var zt = Ot.extend({
        _getValueScaleId: function () {
            return this.getMeta().xAxisID
        }, _getIndexScaleId: function () {
    ...
    }), Et = H.valueOrDefault, Vt = H.options.resolve, Ht = H.canvas._isPointInArea;
    ...
    var ge, me = {
        ...
        })) && ge.default || ge, ve = "$chartjs", be = "chartjs-size-monitor", ye = "chartjs-render-monitor",
        xe = "chartjs-render-animation", _e = ["animationstart", "webkitAnimationStart"], we = {
    ...
    function Te(t, e, n) {
        var i, a, r, o, s = t[ve] || (t[ve] = {}), l = s.resizer = function (t) {
            var e = Pe(be), n = Pe(be + "-expand"), i = Pe(be + "-shrink");
        ...
        addEventListener: function (t, e, n) {
            ...
            if ("resize" !== e) {
                ...
                Se(i, e, (a.proxies || (a.proxies = {}))[t.id + "_" + e] = function (e) {
                    n(function (t, e) {
                        var n = we[t.type] || t.type, i = H.getRelativePosition(t, e);
    ...
    }, Ne = H.valueOrDefault, We = H.rtl.getRtlAdapter;
    W._set("global", {
        tooltips: {
            enabled: !0,
            custom: null,
    ...
    var je = $.extend({
        initialize: function () {
            ...
            var e, n, i, a, r, o, s, l, u, d, h = this, c = h._options, f = h._model, g = h._model = Ve(c),
                m = h._active, p = h._data, v = {xAlign: f.xAlign, yAlign: f.yAlign}, b = {x: f.x, y: f.y},
                y = {width: f.width, height: f.height}, x = {x: f.caretX, y: f.caretY};
            if (m.length) {
                g.opacity = 1;
                var _ = [], w = [];
            ...
            var i, a, r, o, s, l, u, d, h = e.bodyFontSize, c = e.bodySpacing, f = e._bodyAlign, g = e.body,
                m = e.displayColors, p = 0, v = m ? He(e, "left") : 0, b = We(e.rtl, e.x, e.width), y = function (e) {
        ...
        return H.merge({}, [].slice.call(arguments), {
            merger: function (t, e, n, i) {
                if ("xAxes" === t || "yAxes" === t) {
                    ...
                    for (e[t] || (e[t] = []), a = 0; a < s; ++a) o = n[t][a], r = qe(o.type, "xAxes" === t ? "category" : "linear"), a >= e[t].length && e[t].push({}), !e[t][a].type || o.type && o.type !== e[t][a].type ? H.merge(e[t][a], [Re.getScaleDefaults(r), o]) : H.merge(e[t][a], o)
    ...
    H.extend(tn.prototype, {
        construct: function (t, e) {
            ...
            var i = Ie.acquireContext(t, e), a = i && i.canvas, r = a && a.height, o = a && a.width;
            ...
            e.scales && (i = i.concat((e.scales.xAxes || []).map((function (t) {
                ...
                var i = e.options, r = i.id, o = qe(i.type, e.dtype);
            ...
            var n = e.options.animation, i = qe(t.duration, n && n.duration), a = t.lazy;
    ...
    function cn(t, e, n, i) {
        var a, r, o, s, l, u, d, h, c, f, g, m, p, v = n.length, b = [], y = [], x = [];
        for (a = 0; a < v; ++a) {
    ...
    var yn = $.extend({
        zeroLineIndex: 0, getPadding: function () {
            ...
            if (u ? e.width = t.maxWidth : s && (e.width = fn(o) + gn(r)), u ? s && (e.height = fn(o) + gn(r)) : e.height = t.maxHeight, a.display && s) {
                var d = pn(a), h = t._getLabelSizes(), c = h.first, f = h.last, g = h.widest, m = h.highest,
                    p = .4 * d.minor.lineHeight, v = a.padding;
                if (u) {
                    var b = 0 !== t.labelRotation, y = H.toRadians(t.labelRotation), x = Math.cos(y), _ = Math.sin(y),
            ...
            var e, n, i, a, r, o, s, l, u, d, h, c, f, g, m, p, v, b = this, y = b.chart, x = b.options,
                _ = x.gridLines, w = x.position, k = _.offsetGridLines, M = b.isHorizontal(), S = b._ticksToDraw,
                D = S.length + (k ? 1 : 0), C = fn(_), P = [], T = _.drawBorder ? dn(_.lineWidth, 0, 0) : 0, O = T / 2,
                A = H._alignPixel, F = function (t) {
                    return A(y, t, T)
                };
            ...
            var t, e, n, i, a, r, o, s, l, u, d, h, c = this, f = c.options, g = f.ticks, m = f.position, p = g.mirror,
                v = c.isHorizontal(), b = c._ticksToDraw, y = pn(g), x = g.padding, _ = fn(f.gridLines),
                w = -H.toRadians(c.labelRotation), k = [];
            for ("top" === m ? (r = c.bottom - _ - x, o = w ? "left" : "center") : "bottom" === m ? (r = c.top + _ + x, o = w ? "right" : "center") : "left" === m ? (a = c.right - (p ? 0 : _) - x, o = p ? "left" : "right") : (a = c.left + (p ? 0 : _) + x, o = p ? "right" : "left"), t = 0, e = b.length; t < e; ++t) i = (n = b[t]).label, ln(i) || (s = c.getPixelForTick(n._index || t) + g.labelOffset, u = (l = n.major ? y.major : y.minor).lineHeight, d = sn(i) ? i.length : 1, v ? (a = s, h = "top" === m ? ((w ? 1 : .5) - d) * u : (w ? 0 : .5) * u) : (r = s, h = (1 - d) * u / 2), k.push({
                x: a,
                y: r,
                rotation: w,
                label: i,
            ...
            if (n.display) {
                ...
                if (h) {
                    var f, g, m, p, v = h, b = dn(n.lineWidth, c.ticksLength - 1, 1), y = c.borderValue;
            ...
            if (i.display) {
                var a, r, o = un(i.fontColor, W.global.defaultFontColor), s = H.options._parseFont(i),
    ...
    var xn = yn, _n = H.isNullOrUndef, wn = xn.extend({
        ...
        getRightValue: function (t) {
            ...
            var t = this, e = t.options.ticks, n = t.getTickLimit(), i = {
                ...
                var n, i, a, r, o = [], s = t.stepSize, l = s || 1, u = t.maxTicks - 1, d = t.min, h = t.max,
                    c = t.precision, f = e.min, g = e.max, m = H.niceNum((g - f) / u / l) * l;
    ...
    On._defaults = An;
    var Fn = H.valueOrDefault, In = H.math.log10;
    ...
    var Nn = xn.extend({
        determineDataLimits: function () {
            ...
            var t = this, e = t.options.ticks, n = !t.isHorizontal(), i = {min: Rn(e.min), max: Rn(e.max)},
                a = t.ticks = function (t, e) {
                    var n, i, a = [], r = Fn(t.min, Math.pow(10, Math.floor(In(e.min)))), o = Math.floor(In(e.max)),
    ...
    Nn._defaults = Wn;
    var Yn = H.valueOrDefault, zn = H.valueAtIndexOrDefault, En = H.options.resolve, Vn = {
        display: !0,
        animate: !0,
        position: "chartArea",
        ...
        setDimensions: function () {
            ...
            t.display && t.pointLabels.display ? function (t) {
                ...
                for (e = 0; e < d; e++) {
                    ...
                    var h = t.getIndexAngle(e), c = H.toDegrees(h) % 360, f = Bn(c, i.x, n.w, 0, 180),
            ...
            var t, e, n, i = this, a = i.ctx, r = i.options, o = r.gridLines, s = r.angleLines,
                l = Yn(s.lineWidth, o.lineWidth), u = Yn(s.color, o.color);
            if (r.pointLabels.display && function (t) {
                ...
                0 !== n && (e = i.getDistanceFromCenterForValue(i.ticksAsNumbers[n]), function (t, e, n, i) {
                    var a, r = t.ctx, o = e.circular, s = t.chart.data.labels.length, l = zn(e.color, i - 1),
    ...
    Zn._defaults = $n;
    var Xn = H._deprecated, Kn = H.options.resolve, Jn = H.valueOrDefault,
    ...
    var hi = xn.extend({
        initialize: function () {
            ...
            var t, e, n, i, a, r, o, s = this, l = s.chart, u = s._adapter, d = s.options, h = d.time.unit || "day",
                c = ti, f = Qn, g = [], m = [], p = [], v = s._getLabels();
            for (t = 0, n = v.length; t < n; ++t) p.push(li(s, v[t]));
            for (t = 0, n = (l.data.datasets || []).length; t < n; ++t) if (l.isDatasetVisible(t)) if (a = l.data.datasets[t].data, H.isObject(a[0])) for (m[t] = [], e = 0, i = a.length; e < i; ++e) r = li(s, a[e]), g.push(r), m[t][e] = r; else m[t] = p.slice(0), o || (g = g.concat(p), o = !0); else m[t] = [];
            ...
            for (u = "data" === c || "auto" === c && "series" === f ? u.data : "labels" === c ? u.labels : function (t, e, n, i) {
                var a, r = t._adapter, o = t.options, s = o.time, l = s.unit || ui(s.minUnit, e, n, i),
                    u = Kn([s.stepSize, s.unitStepSize, 1]), d = "week" === l && s.isoWeekday, h = e, c = [];
            ...
            var a = this._adapter, r = this.options, o = r.time.displayFormats, s = o[this._unit], l = this._majorUnit,
                ...
                g = c ? h.major : h.minor, m = Kn([g.callback, g.userCallback, h.callback, h.userCallback]);
            return m ? m(f, e, n) : f
    ...
    hi._defaults = ci;
    var fi = {category: wn, linear: On, logarithmic: Nn, radialLinear: Zn, time: hi}, gi = e((function (e, n) {
        e.exports = function () {
            var n, i;
            ...
            var q = /\d/, Z = /\d\d/, $ = /\d{3}/, X = /\d{4}/, K = /[+-]?\d{6}/, J = /\d\d?/, Q = /\d\d\d\d?/,
                tt = /\d\d\d\d\d\d?/, et = /\d{1,3}/, nt = /\d{1,4}/, it = /[+-]?\d{1,6}/, at = /\d+/, rt = /[+-]?\d+/,
                ot = /Z|[+-]\d\d:?\d\d/gi, st = /Z|[+-]\d\d(?::?\d\d)?/gi,
            ...
            var Xt = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                Kt = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Jt = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
            ...
            function ze(t) {
                var e = N(t), n = e.year || 0, i = e.quarter || 0, a = e.month || 0, r = e.week || e.isoWeek || 0,
            ...
            function je(t, e) {
                ...
                var i = ((n[n.length - 1] || []) + "").match(Be) || ["-", 0, 0], a = 60 * i[1] + k(i[2]);
            ...
            function tn(t, e, n, i) {
                var r = e._milliseconds, o = Ve(e._days), s = Ve(e._months);
            ...
            var en = Qe(1, "add"), nn = Qe(-1, "subtract");
            ...
            function vn(t, e, n, i, a) {
                var r = Gt(t, e, n, i, a), o = jt(r.year, 0, r.dayOfYear);
            ...
            Mn.add = en, Mn.calendar = function (t, e) {
                var n = t || Le(), i = Ue(n, this).startOf("day"), r = a.calendarFormat(this, i) || "sameElse",
            ...
            var Nn = Rn("ms"), Wn = Rn("s"), Yn = Rn("m"), zn = Rn("h"), En = Rn("d"), Vn = Rn("w"), Hn = Rn("M"),
                Bn = Rn("Q"), jn = Rn("y");
            ...
            var Gn = Un("milliseconds"), qn = Un("seconds"), Zn = Un("minutes"), $n = Un("hours"), Xn = Un("days"),
                Kn = Un("months"), Jn = Un("years"), Qn = Math.round, ti = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11};
            ...
            function ai() {
                ...
                var r = w(a / 12), o = a %= 12, s = i, l = e, u = t, d = n ? n.toFixed(3).replace(/\.?0+$/, "") : "",
                    h = this.asSeconds();
                if (!h) return "P0D";
                var c = h < 0 ? "-" : "", f = ii(this._months) !== ii(h) ? "-" : "",
                    g = ii(this._days) !== ii(h) ? "-" : "", m = ii(this._milliseconds) !== ii(h) ? "-" : "";
            ...
            return ri.isValid = function () {
                ...
                var e = this.localeData(), n = function (t, e, n) {
                    var i = Xe(t).abs(), a = Qn(i.as("s")), r = Qn(i.as("m")), o = Qn(i.as("h")), s = Qn(i.as("d")),
                        l = Qn(i.as("M")), u = Qn(i.as("y")),
    ...
    var Mi = {
        id: "filler", afterDatasetsUpdate: function (t, e) {
            ...
            for (i = 0; i < o; ++i) r = null, (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof wt.Line && (r = {
    ...
    }, Si = H.rtl.getRtlAdapter, Di = H.noop, Ci = H.valueOrDefault;
    ...
    var Ti = $.extend({
        initialize: function (t) {
        ...
        }, beforeUpdate: Di, update: function (t, e, n) {
            var i = this;
            return i.beforeUpdate(), i.maxWidth = t, i.maxHeight = e, i.margins = n, i.beforeSetDimensions(), i.setDimensions(), i.afterSetDimensions(), i.beforeBuildLabels(), i.buildLabels(), i.afterBuildLabels(), i.beforeFit(), i.fit(), i.afterFit(), i.afterUpdate(), i.minSize
        }, afterUpdate: Di, beforeSetDimensions: Di, setDimensions: function () {
            var t = this;
            t.isHorizontal() ? (t.width = t.maxWidth, t.left = 0, t.right = t.width) : (t.height = t.maxHeight, t.top = 0, t.bottom = t.height), t.paddingLeft = 0, t.paddingTop = 0, t.paddingRight = 0, t.paddingBottom = 0, t.minSize = {
                width: 0,
                height: 0
            }
        }, afterSetDimensions: Di, beforeBuildLabels: Di, buildLabels: function () {
            var t = this, e = t.options.labels || {}, n = H.callback(e.generateLabels, [t.chart], t) || [];
            e.filter && (n = n.filter((function (n) {
                return e.filter(n, t.chart.data)
            }))), t.options.reverse && n.reverse(), t.legendItems = n
        }, afterBuildLabels: Di, beforeFit: Di, fit: function () {
            ...
            if (u ? (l.width = t.maxWidth, l.height = i ? 10 : 0) : (l.width = i ? 10 : 0, l.height = t.maxHeight), i) {
                if (a.font = r.string, u) {
                    ...
                    var c = n.padding, f = t.columnWidths = [], g = t.columnHeights = [], m = n.padding, p = 0, v = 0;
        ...
        }, afterFit: Di, isHorizontal: function () {
            return "top" === this.options.position || "bottom" === this.options.position
        }, draw: function () {
            var t = this, e = t.options, n = e.labels, i = W.global, a = i.defaultColor, r = i.elements.line,
                o = t.height, s = t.columnHeights, l = t.width, u = t.lineWidths;
            if (e.display) {
                var d, h = Si(e.rtl, t.left, t.minSize.width), c = t.ctx, f = Ci(n.fontColor, i.defaultFontColor),
                    g = H.options._parseFont(n), m = g.size;
                c.textAlign = h.textAlign("left"), c.textBaseline = "middle", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = g.string;
                var p = Pi(n, m), v = t.legendHitBoxes, b = function (t, i) {
                    switch (e.align) {
                        case"start":
                            return n.padding;
                        case"end":
                ...
                d = y ? {x: t.left + b(l, u[0]), y: t.top + n.padding, line: 0} : {
                    x: t.left + n.padding,
                    y: t.top + b(o, s[0]),
                    line: 0
                ...
                H.each(t.legendItems, (function (e, i) {
                    var f = c.measureText(e.text).width, g = p + m / 2 + f, _ = d.x, w = d.y;
                    ...
                    !function (t, e, i) {
                        if (!(isNaN(p) || p <= 0)) {
                            ...
                            if (c.fillStyle = Ci(i.fillStyle, a), c.lineCap = Ci(i.lineCap, r.borderCapStyle), c.lineDashOffset = Ci(i.lineDashOffset, r.borderDashOffset), c.lineJoin = Ci(i.lineJoin, r.borderJoinStyle), c.lineWidth = o, c.strokeStyle = Ci(i.strokeStyle, a), c.setLineDash && c.setLineDash(Ci(i.lineDash, r.borderDash)), n && n.usePointStyle) {
                                var s = p * Math.SQRT2 / 2, l = h.xPlus(t, p / 2), u = e + m / 2;
                        ...
                        var a = m / 2, r = h.xPlus(t, p + a), o = e + a;
    ...
    var Ai = {
        id: "legend", _element: Ti, beforeInit: function (t) {
    ...
    var Ii = $.extend({
        ...
        draw: function () {
            ...
            if (n.display) {
                ...
                var g = n.text;
                if (H.isArray(g)) for (var m = 0, p = 0; p < g.length; ++p) e.fillText(g[p], 0, m, i), m += s; else e.fillText(g, 0, 0, i);
                e.restore()
            }
        }
    });
    ...
    })), Ri) Ri.hasOwnProperty(zi) && en.plugins.register(Ri[zi]);
